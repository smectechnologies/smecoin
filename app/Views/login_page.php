              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="<?= base_url('login') ?>" method="POST">
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example11" class="form-control" name="email" placeholder="Phone number or email address" required />
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="<?= base_url('register') ?>"><button type="button" class="btn btn-outline-danger">Create new</button></a>
                  </div>
